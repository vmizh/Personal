...
public class Diagnostics
{
    ...
    private DiagnosticListener servicestack { get; } = new DiagnosticListener(Listeners.ServiceStack);
    private DiagnosticListener client { get; } = new DiagnosticListener(Listeners.Client);
    private DiagnosticListener ormlite { get; } = new DiagnosticListener(Listeners.OrmLite);
    private DiagnosticListener redis { get; } = new DiagnosticListener(Listeners.Redis);
