...
public class DynamicSByte : IDynamicNumber
{
    ...
    {
        return Math.Min(Convert(lhs), Convert(rhs));
    }

    public object max(object lhs, object rhs)
    {
        return Math.Max(Convert(lhs), Convert(rhs));
    }

    public object pow(object lhs, object rhs)
    {
        return Math.Pow(Convert(lhs), Convert(rhs));
    }

    public object log(object lhs, object rhs)
    {
        return Math.Log(Convert(lhs), Convert(rhs));
    }

    public int compareTo(object lhs, object rhs)
    {
        return Convert(lhs).CompareTo(Convert(rhs));
    }
    ...
    public object bitwiseNot(object target)
    {
...
public class DynamicUInt : IDynamicNumber
{
    ...
    public object bitwiseLeftShift(object lhs, object rhs)
    {
        return Convert(lhs) << (int)Convert(rhs);
    }
...
public class DynamicFloat : IDynamicNumber
{
    ...
    public string ToString(object value)
    {
        return Convert(value).ToString("r", CultureInfo.InvariantCulture);
    }
...
public class DynamicDecimal : IDynamicNumber
{
    ...
    public string ToString(object value)
    {
        return Convert(value).ToString(CultureInfo.InvariantCulture);
    }
    ...
    public object pow(object lhs, object rhs)
    {
        return Math.Pow((double)Convert(lhs), (double)Convert(rhs));
    }

    public object log(object lhs, object rhs)
    {
        return Math.Log((double)Convert(lhs), (double)Convert(rhs));
    }
...
{
    private static readonly Dictionary<int, IDynamicNumber> RankNumbers = new Dictionary<int, IDynamicNumber>
    {
