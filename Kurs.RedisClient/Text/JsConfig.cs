...
public static class JsConfig
{
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.ConvertObjectTypesIntoStringDictionary
            : Config.Instance.ConvertObjectTypesIntoStringDictionary;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.TryToParsePrimitiveTypeValues
            : Config.Instance.TryToParsePrimitiveTypeValues;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.TryToParseNumericType
            : Config.Instance.TryToParseNumericType;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.TryParseIntoBestFit
            : Config.Instance.TryParseIntoBestFit;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.ParsePrimitiveFloatingPointTypes
            : Config.Instance.ParsePrimitiveFloatingPointTypes;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.ParsePrimitiveIntegerTypes
            : Config.Instance.ParsePrimitiveIntegerTypes;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.ExcludePropertyReferences
            : Config.Instance.ExcludePropertyReferences;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.ExcludeDefaultValues
            : Config.Instance.ExcludeDefaultValues;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.IncludeNullValues
            : Config.Instance.IncludeNullValues;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.IncludeNullValuesInDictionaries
            : Config.Instance.IncludeNullValuesInDictionaries;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.IncludeDefaultEnums
            : Config.Instance.IncludeDefaultEnums;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.TreatEnumAsInteger
            : Config.Instance.TreatEnumAsInteger;
    ...
    internal static string JsonTypeAttrInObject => JsConfigScope.Current != null
        ? JsConfigScope.Current.JsonTypeAttrInObject
        : Config.Instance.JsonTypeAttrInObject;

    internal static string JsvTypeAttrInObject => JsConfigScope.Current != null
        ? JsConfigScope.Current.JsvTypeAttrInObject
        : Config.Instance.JsvTypeAttrInObject;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.ParsePrimitiveFn
            : Config.Instance.ParsePrimitiveFn;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.SystemJsonCompatible
            : Config.Instance.SystemJsonCompatible;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.EmitCamelCaseNames
            : Config.Instance.EmitCamelCaseNames;
    ...
    public static bool EmitLowercaseUnderscoreNames
    {
        ...
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.EmitLowercaseUnderscoreNames
            : Config.Instance.EmitLowercaseUnderscoreNames;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.PropertyConvention
            : Config.Instance.PropertyConvention;
    ...
    /// <summary>
    ///     Gets or sets a value indicating if the framework should always convert <see cref="DateTime" /> to UTC format
    ...
    public static bool SkipDateTimeConversion
    {
        // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.SkipDateTimeConversion
            : Config.Instance.SkipDateTimeConversion;
        set => Config.AssertNotInit().SkipDateTimeConversion = value;
    }

    /// <summary>
    ///     Gets or sets a value indicating if the framework should always assume <see cref="DateTime" /> is in UTC format if
    ///     Kind is Unspecified.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    ///     Parameters have following meaning in order: deserialized entity, property name, parsed value, property type,
    ///     caught exception.
    /// </remarks>
    public static DeserializationErrorDelegate OnDeserializationError
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.OnDeserializationError
            : Config.Instance.OnDeserializationError;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.PreferInterfaces
            : Config.Instance.PreferInterfaces;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.IncludePublicFields
            : Config.Instance.IncludePublicFields;
    ...
    {
        get => JsConfigScope.Current != null
            ? JsConfigScope.Current.ExcludeTypeNames
            : Config.Instance.ExcludeTypeNames;
    ...
    public static HashSet<string> AllowRuntimeTypeWithAttributesNamed { get; set; } = new HashSet<string>();

    public static HashSet<string> AllowRuntimeTypeWithInterfacesNamed { get; set; } = new HashSet<string>();

    public static HashSet<string> AllowRuntimeTypeInTypes { get; set; } = new HashSet<string>();

    public static HashSet<string> AllowRuntimeTypeInTypesWithNamespaces { get; set; } = new HashSet<string>();
        ...
        bool? useSystemParseMethods = null) //Unused
    {
        ...
        {
            ConvertObjectTypesIntoStringDictionary = convertObjectTypesIntoStringDictionary ??
                                                     Config.Instance.ConvertObjectTypesIntoStringDictionary,
            TryToParsePrimitiveTypeValues =
                tryToParsePrimitiveTypeValues ?? Config.Instance.TryToParsePrimitiveTypeValues,
            TryToParseNumericType = tryToParseNumericType ?? Config.Instance.TryToParseNumericType,

            ParsePrimitiveFloatingPointTypes =
                parsePrimitiveFloatingPointTypes ?? Config.Instance.ParsePrimitiveFloatingPointTypes,
            ...
            IncludeNullValuesInDictionaries =
                includeNullValuesInDictionaries ?? Config.Instance.IncludeNullValuesInDictionaries,
    ...
    {
        return JsConfigScope.Current != null ? JsConfigScope.Current : Config.Instance;
    }

    internal static bool TreatAsRefType(Type valueType)
    {
        return TreatValueAsRefTypes.Contains(valueType.IsGenericType
    ...
    {
        return ExcludeTypes.Contains(propType) || ExcludeTypeNames.Contains(propType.FullName);
    }

    public static void Reset()
    {
        foreach (var rawSerializeType in HasSerializeFn.ToArray()) Reset(rawSerializeType);
        foreach (var rawSerializeType in HasIncludeDefaultValue.ToArray()) Reset(rawSerializeType);
        foreach (var uniqueType in __uniqueTypes.ToArray()) Reset(uniqueType);
...
public class JsConfig<T>
{
    ...
    public static Func<string, T> RawDeserializeFn
    {
        ...
        set
        {
            rawDeserializeFn = value;
            RefreshRead();
        }
    }

    public static bool HasDeserializeFn =>
        !JsState.InDeserializer<T>() && (DeSerializeFn != null || RawDeserializeFn != null);
