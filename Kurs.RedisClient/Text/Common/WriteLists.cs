    ...
    where TSerializer : ITypeSerializer
{
    ...
    private static Dictionary<Type, WriteObjectDelegate> ListCacheFns = new Dictionary<Type, WriteObjectDelegate>();


    private static Dictionary<Type, WriteObjectDelegate> IListCacheFns = new Dictionary<Type, WriteObjectDelegate>();

    private static Dictionary<Type, WriteObjectDelegate> CacheFns = new Dictionary<Type, WriteObjectDelegate>();

    private static Dictionary<Type, WriteObjectDelegate> EnumerableCacheFns =
        new Dictionary<Type, WriteObjectDelegate>();

    private static Dictionary<Type, WriteObjectDelegate> ListValueTypeCacheFns =
        new Dictionary<Type, WriteObjectDelegate>();

    private static Dictionary<Type, WriteObjectDelegate> IListValueTypeCacheFns =
        new Dictionary<Type, WriteObjectDelegate>();
