    ...
    where TSerializer : ITypeSerializer
{
    ...
    private static readonly Type[] signature =
        { typeof(ReadOnlySpan<char>), typeof(Type), typeof(ParseStringSpanDelegate), typeof(ParseStringSpanDelegate) };
    ...
    public static ParseStringSpanDelegate GetParseStringSpanMethod(Type type)
    {
        ...
        return value =>
            ParseKeyValuePairType(value, createMapType, keyValuePairArgs, keyTypeParseMethod, valueTypeParseMethod);
    }
    ...
    {
        return ParseKeyValuePair<TKey, TValue>(value.AsSpan(), createMapType,
    ...
    private static int VerifyAndGetStartIndex(ReadOnlySpan<char> value, Type createMapType)
    {
        ...
        if (!Serializer.EatMapStartChar(value, ref index))
            ...
            Tracer.Instance.WriteDebug(
                ...
                JsWriter.MapStartChar, createMapType != null ? createMapType.Name : "Dictionary<,>",
    ...
    {
        return ParseKeyValuePairType(value.AsSpan(), createMapType, argTypes,
