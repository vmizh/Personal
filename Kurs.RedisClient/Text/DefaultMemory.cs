...
public sealed class DefaultMemory : MemoryProvider
{
    ...
    {
        return SignedInteger<short>.ParseInt16(value);
    }

    public override ushort ParseUInt16(ReadOnlySpan<char> value)
    {
        return UnsignedInteger<ushort>.ParseUInt16(value);
    }
    ...
    {
        return UnsignedInteger<uint>.ParseUInt32(value);
    }
    ...
    {
        return SignedInteger<int>.ParseInt64(value);
    }

    public override ulong ParseUInt64(ReadOnlySpan<char> value)
    {
        return UnsignedInteger<ulong>.ParseUInt64(value);
    }
    ...
    private static async Task WriteAsyncAndReturn(Stream stream, byte[] bytes, int offset, int count,
    ...
    {
        return WriteAsync(stream, value.Span, token);
    }
    ...
    {
        return Encoding.UTF8.GetCharCount(bytes.ToArray());
        //SLOW
    }

    public override int GetUtf8ByteCount(ReadOnlySpan<char> chars)
    {
        return Encoding.UTF8.GetByteCount(chars.ToArray());
        //SLOW
    }
    ...
    {
        return Encoding.UTF8.GetBytes(source.ToArray());
    }

    public override string FromUtf8Bytes(ReadOnlySpan<byte> source)
    {
        return Encoding.UTF8.GetString(source.WithoutBom().ToArray());
    }

    public override MemoryStream ToMemoryStream(ReadOnlySpan<byte> source)
    {
        return MemoryStreamFactory.GetStream(source.ToArray());
    }
...
internal static class SignedInteger<T> where T : struct, IComparable<T>, IEquatable<T>, IConvertible
{
    ...
    public static short ParseInt16(ReadOnlySpan<char> value)
    {
        return (short)ParseInt64(value);
    }
...
internal static class UnsignedInteger<T> where T : struct, IComparable<T>, IEquatable<T>, IConvertible
{
    ...
    public static ushort ParseUInt16(ReadOnlySpan<char> value)
    {
        return (ushort)ParseUInt64(value);
    }

    public static uint ParseUInt32(ReadOnlySpan<char> value)
    {
        return (uint)ParseUInt64(value);
    }
